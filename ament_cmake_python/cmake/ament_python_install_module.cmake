...
function(_ament_cmake_python_install_module module_file)
  if(ARGN)
    message(FATAL_ERROR "ament_python_install_module() called with unused arguments: ${ARGN}")
  endif()
  ...
  if(NOT EXISTS "${module_file}")
    message(FATAL_ERROR "ament_python_install_module() the Python module file '${module_file}' doesn't exist")
  endif()

  if(NOT PYTHON_INSTALL_DIR)
    message(FATAL_ERROR "ament_python_install_module() variable 'PYTHON_INSTALL_DIR' must not be empty")
  endif()
  install(
    FILES "${module_file}"
  ...
  if(NOT index EQUAL -1)
    message(FATAL_ERROR "ament_python_install_module() a Python module file or package with the same name '${name}' has been installed before")
  endif()
