  ...
  if(AMENT_EXTENSIONS_${extension_point})
    foreach(_extension ${AMENT_EXTENSIONS_${extension_point}})
      ...
      if(NOT _length EQUAL 2)
        message(FATAL_ERROR "ament_execute_extensions(${extension_point}) registered extension '${_extension}' can not be split into package name and cmake filename")
      endif()
      ...
      assert_file_exists("${_extension_file}" "ament_execute_extensions(${extension_point}) registered extension '${_extension_file}' does not exist")
