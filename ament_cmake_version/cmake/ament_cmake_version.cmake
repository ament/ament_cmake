...
function(ament_cmake_version)
  if (NOT ${ARGC} EQUAL 0)
    message(FATAL_ERROR "ament_cmake_version does not accept parameters but ${ARGC} parameters provided")
  endif()

  # Find myself so I can use my own cmake instalation folder `ament_cmake_version_DIR`
  # I can't rely on a pervious find_package call because it could be a direct call
  find_package(ament_cmake_version REQUIRED)
  set(TEMPLATE_FILE "${ament_cmake_version_DIR}/version.h.in")
  if(NOT EXISTS "${TEMPLATE_FILE}")
    message(FATAL_ERROR "Can't find ${TEMPLATE_FILE}. Reinstall ament_cmake_version package.")
  endif()
