...
if(NOT ament_cmake_FIND_COMPONENTS)
  set(ament_cmake_FIND_COMPONENTS "core" "environment" "environment_hooks" "export_definitions" "export_dependencies" "export_include_directories" "export_interfaces" "export_libraries" "gmock" "gtest" "index" "nose" "python" "symlink_install" "test")
endif()
