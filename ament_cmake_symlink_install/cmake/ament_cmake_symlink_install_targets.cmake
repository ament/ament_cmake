...
function(ament_cmake_symlink_install_targets)
  if(NOT "${ARGV0}" STREQUAL "TARGETS")
    message(FATAL_ERROR "ament_cmake_symlink_install_targets() first argument must be 'TARGETS', not '${ARGV0}'")
  endif()
  ...
  if(index EQUAL -1)
    ...
    cmake_parse_arguments(ARG "ARCHIVE;LIBRARY;RUNTIME;OPTIONAL" "DESTINATION" "TARGETS" ${ARGN})
    ...
    foreach(target ${ARG_TARGETS})
      if(NOT TARGET ${target})
        message(FATAL_ERROR "ament_cmake_symlink_install_targets() '${target}' is not a target")
      endif()
      get_target_property(is_imported "${target}" IMPORTED)
      if(is_imported)
        message(FATAL_ERROR "ament_cmake_symlink_install_targets() '${target}' is an imported target")
      endif()
    ...
    string(REPLACE ";" "\" \"" target_files_quoted "\"TARGET_FILES;${target_files}\"")
