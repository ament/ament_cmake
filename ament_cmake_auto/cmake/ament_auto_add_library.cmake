...
macro(ament_auto_add_library target)
  cmake_parse_arguments(ARG "STATIC;SHARED;MODULE;EXCLUDE_FROM_ALL;NO_TARGET_LINK_LIBRARIES" "DIRECTORY" "" ${ARGN})
  if(NOT ARG_DIRECTORY AND NOT ARG_UNPARSED_ARGUMENTS)
    message(FATAL_ERROR "ament_auto_add_library() called without any source files and without a DIRECTORY argument")
  endif()
  ...
  if(ARG_DIRECTORY)
    ...
    if(NOT _source_files)
      message(FATAL_ERROR "ament_auto_add_library() no source files found in directory '${CMAKE_CURRENT_SOURCE_DIR}/${ARG_DIRECTORY}'")
    endif()
  endif()
